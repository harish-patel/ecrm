 ...
 * PLACE ANY CUSTOMIZATIONS IN ed_Employee
 */

require_once('include/SugarObjects/templates/person/Person.php');

class ed_Employee_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'ed_Employee';
	var $object_name = 'ed_Employee';
	var $table_name = 'ed_employee';
	var $importable = true;
		var $id;
		var $name;
		var $date_entered;
		...
		var $email_addresses;
		var $picture;
		var $employee_unique_id;
			function ed_Employee_sugar(){	
		parent::Person();
	}
