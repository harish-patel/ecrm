...
$connector_strings = array (
  ...
  'ERROR_MISSING_SOAP_LIBRARIES' => 'エラー：SOAPライブラリ（SoapClient、SoapHeader）がロードできません。',
  'LBL_ID' => 'ID',
  'hoovers_wsdl' => 'WSDL URL',
  'LBL_LICENSING_INFO' => 'Hoovers©はSugarCRMのユーザーに企業の最新情報を無料でお届けします。各企業・業界・重役に関してのより包括的な情報や報告をご覧になりたい場合はhttp://www.hoovers.com（英語）をご訪問ください。',
  'LBL_NAME' => '会社名',
  'LBL_STREET' => '番地',
  'LBL_CITY' => '市群区町村',
  'LBL_STATE' => '都道府県',
