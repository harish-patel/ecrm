...
$mod_strings = array (
  ...
  'MSG_DUPLICATE' => 'Намерени предварителни контакти. Моля, маркирайте тези клиенти, които искате да асоциирате със записа, който ще бъде създаден с това конвертиране. След това, моля натиснете Продължи.',
