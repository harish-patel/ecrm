...
abstract class DBManager
{
    ...
    SugarBean $bean, array $where = array()
    )
    {
    ...
    array $beans, array $cols = array(), array $where = array()
    )
    {
    ...
    $tablename, $fieldDefs, $indices, $engine = null
    )
    {
        if (!empty($fieldDefs))
        {
    ...
    $tablename, $fielddefs, $indices, $execute = true, $engine = null
    )
    {
    ...
    SugarBean $bean, $fieldDefs, $name, $unique = true
    )
    {
    ...
    $tablename, $indexes, $execute = true
    )
    {
    ...
    $tablename, $newFieldDef, $ignoreRequired = false
    )
    {
        $this->tableName = $tablename;
    ...
    $query, $start, $count, $dieOnError = false, $msg = '')
    {
    ...
    SugarBean $bean, $select_query, $start, $count = -1, $table, $db_type, $is_related_query = false
    )
    {
    ...
    $sql, $dieOnError = false, $msg = '', $suppress = false
    );
    ...
    $sql, $start, $count, $dieOnError = false, $msg = '');
    ...
    $sql, $dieOnError = false, $msg = '', $encode = true
    )
    {
    ...
    array $configOptions = null, $dieOnError = false
    );
    ...
    $string, $type, array $additional_parameters = array(), array $additional_parameters_oracle_only = array()
    )
    {
        return "$string";
    }
