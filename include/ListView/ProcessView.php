...
class ProcessView
{
    ...
    function translate_element(& $option_array)
    {
        ...
        if ($type == "module")
        {
            ...
            elseif (!empty($app_list_strings['moduleList'][ucfirst($target_element)]))
            {//bug 27267: This is not a good fix, here the $target_element is the field name of vardefs.  Sometimes it may not in the moduleList
